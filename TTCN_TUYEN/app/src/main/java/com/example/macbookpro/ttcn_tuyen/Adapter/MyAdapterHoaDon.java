...
public class MyAdapterHoaDon extends RecyclerView.Adapter<MyAdapterHoaDon.ViewHolder> {
    private OrderActivity context;

    private List<Order> orderList;
    private Context hihi;

    public MyAdapterHoaDon(OrderActivity context, List<Order> orderList) {
        this.context = context;
        this.orderList = orderList;
    }

    public MyAdapterHoaDon(List<Order> orderList, Context context) {
        this.orderList = orderList;
        this.hihi = hihi;
    }
