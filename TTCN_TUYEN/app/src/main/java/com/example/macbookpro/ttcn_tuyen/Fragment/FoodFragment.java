...
public class FoodFragment extends Fragment {
    ...
    public static FoodFragment newInstance(int page, String title) {
        FoodFragment contactsFragment = new FoodFragment();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView) view.findViewById(R.id.recuclerViewfood);
